    ...
    return [
      {
        ...
        description:
          'Aplicativo web que calcula automaticamente pontos e milhas acumulados com base nos gastos mensais. Utiliza Zustand, TailwindCSS, React Hook Form e Shadcn UI.',
      ...
      },
      {
        ...
        title: 'ARACOMP (UFAL)',
        description:
          'Site institucional para o evento acadêmico da Universidade Federal de Alagoas, desenvolvido com Django, Django REST Framework, HTML e SCSS.',
      ...
      },
      {
        ...
        title: 'CDP Platform',
        description:
          'Plataforma de gestão de dados de clientes e personalização de mensagens multicanal. Arquitetura modular e hexagonal na camada de serviços.',
