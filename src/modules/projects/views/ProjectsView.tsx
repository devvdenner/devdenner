    ...
    return (
        <Section id="projects">
                        ...
                        <div key={project.id} className="grid items-center gap-8 md:grid-cols-12">
                            ...
                            <div className={cn(
                                ...
                                <div className="relative flex aspect-video items-center justify-center overflow-hidden rounded border border-slate-700 bg-surface shadow-2xl">
                                    <img src={project.image} alt={project.imagePlaceholder} className="size-full object-cover" />
                                </div>
                            </div>
                            ...
                            <div className={cn(
                                ...
                                <div className={cn(
                                    ...
                                    <a href={project.links.github} className="text-slate-300 transition-colors hover:text-primary"><Github size={20} /></a>
                                    <a href={project.links.external} className="text-slate-300 transition-colors hover:text-primary"><ExternalLink size={20} /></a>
                                </div>
                            </div>
                        </div>
                    );
            ...
            <div className="mt-20 text-center">
                <a href="#" className="inline-flex items-center gap-2 rounded border border-primary px-8 py-4 font-bold text-primary transition-colors hover:bg-primary/10">
